$PBExportHeader$n_cst_popupcanvas.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type n_cst_popupcanvas from n_popupcanvas
end type
end forward

global type n_cst_popupcanvas from n_popupcanvas
end type
global n_cst_popupcanvas n_cst_popupcanvas
...
on n_cst_popupcanvas.create
call super::create
end on

on n_cst_popupcanvas.destroy
call super::destroy
end on
