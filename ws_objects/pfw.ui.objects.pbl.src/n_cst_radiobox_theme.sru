$PBExportHeader$n_cst_radiobox_theme.sru
$PBExportComments$PowerUI~r~nBy gaoqiangz@msn.com
forward
global type n_cst_radiobox_theme from n_cst_base_theme
end type
type font from n_cst_font within n_cst_radiobox_theme
end type
end forward
...
global n_cst_radiobox_theme n_cst_radiobox_theme
...
public function long of_settextposition (unsignedinteger position)
end prototypes
...
if IsAncestor(newTheme,"n_cst_radiobox_theme") then
	n_cst_radiobox_theme ln_newTheme
...
public function long of_settextposition (unsignedinteger position);if #TextPosition = position then return RetCode.OK
...
on n_cst_radiobox_theme.create
call super::create
this.font=create font
end on

on n_cst_radiobox_theme.destroy
call super::destroy
destroy(this.font)
end on
