$PBExportHeader$n_cst_treeview_theme.sru
$PBExportComments$PowerUI~r~nBy gaoqiangz@msn.com
forward
global type n_cst_treeview_theme from n_cst_base_theme
end type
end forward

global type n_cst_treeview_theme from n_cst_base_theme
end type
global n_cst_treeview_theme n_cst_treeview_theme
...
Constant Uint EVT_SCROLLBARARROWSIZE			= EVT_CUSTOM + 3
Constant Uint EVT_SCROLLBARROUNDSIZE			= EVT_CUSTOM + 4
Constant Uint EVT_SCROLLBARBORDERMARGIN	= EVT_CUSTOM + 5
...
if IsAncestor(newTheme,"n_cst_treeview_theme") then
	n_cst_treeview_theme ln_newTheme
...
on n_cst_treeview_theme.create
call super::create
end on

on n_cst_treeview_theme.destroy
call super::destroy
end on
