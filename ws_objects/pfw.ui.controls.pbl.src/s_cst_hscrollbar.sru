$PBExportHeader$s_cst_hscrollbar.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type s_cst_hscrollbar from hscrollbar
end type
type theme from n_cst_scrollbar_theme within s_cst_hscrollbar
end type
end forward
...
global s_cst_hscrollbar s_cst_hscrollbar
...
on s_cst_hscrollbar.create
this.theme=create theme
end on

on s_cst_hscrollbar.destroy
destroy(this.theme)
end on

type theme from n_cst_scrollbar_theme within s_cst_hscrollbar descriptor "pb_nvo" = "true" 
end type
