...
constant string PACK_APP_PBD	= "pfw.internal.packuse.pbd"
...
event open;_wf_AddDepend(cbx_ui,cbx_utility_container)
...
type cbx_utility_invoker from checkbox within w_packager
string tag = "pfw.utility.invoker:.*"
integer x = 55
integer y = 1296
integer width = 347
integer height = 96
