$PBExportHeader$se_cst_dropdownlist.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_dropdownlist from s_cst_dropdownlist
end type
end forward
...
global se_cst_dropdownlist se_cst_dropdownlist
...
on se_cst_dropdownlist.create
call super::create
end on

on se_cst_dropdownlist.destroy
call super::destroy
end on
