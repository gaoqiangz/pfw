$PBExportHeader$se_cst_hscrollbar.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_hscrollbar from s_cst_hscrollbar
end type
end forward
...
global se_cst_hscrollbar se_cst_hscrollbar
...
on se_cst_hscrollbar.create
call super::create
end on

on se_cst_hscrollbar.destroy
call super::destroy
end on
