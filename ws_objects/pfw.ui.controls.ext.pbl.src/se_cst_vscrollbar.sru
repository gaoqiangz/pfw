$PBExportHeader$se_cst_vscrollbar.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_vscrollbar from s_cst_vscrollbar
end type
end forward
...
global se_cst_vscrollbar se_cst_vscrollbar
...
on se_cst_vscrollbar.create
call super::create
end on

on se_cst_vscrollbar.destroy
call super::destroy
end on
