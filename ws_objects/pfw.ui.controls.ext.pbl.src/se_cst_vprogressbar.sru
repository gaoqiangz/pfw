$PBExportHeader$se_cst_vprogressbar.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_vprogressbar from s_cst_vprogressbar
end type
end forward
...
global se_cst_vprogressbar se_cst_vprogressbar
...
on se_cst_vprogressbar.create
call super::create
end on

on se_cst_vprogressbar.destroy
call super::destroy
end on
