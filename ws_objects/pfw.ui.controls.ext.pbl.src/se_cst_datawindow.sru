$PBExportHeader$se_cst_datawindow.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_datawindow from s_cst_datawindow
end type
end forward
...
global se_cst_datawindow se_cst_datawindow
...
on se_cst_datawindow.create
call super::create
end on

on se_cst_datawindow.destroy
call super::destroy
end on
...
event onthemechanged;call super::onthemechanged;choose case eventFlag
	case theme.EVT_BKGNDCOLORSTYLE
		if Visible then
			Win32.RedrawWindow(#Handle,0,0,Win32.RDW_INVALIDATE + Win32.RDW_ERASE + Win32.RDW_NOFRAME + Win32.RDW_ALLCHILDREN)
		end if
end choose
end event
