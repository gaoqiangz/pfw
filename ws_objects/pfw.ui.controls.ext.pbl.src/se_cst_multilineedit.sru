$PBExportHeader$se_cst_multilineedit.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_multilineedit from s_cst_multilineedit
end type
end forward
...
global se_cst_multilineedit se_cst_multilineedit
...
on se_cst_multilineedit.create
call super::create
end on

on se_cst_multilineedit.destroy
call super::destroy
end on
