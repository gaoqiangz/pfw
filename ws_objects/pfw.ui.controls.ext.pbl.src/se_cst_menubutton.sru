$PBExportHeader$se_cst_menubutton.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_menubutton from s_cst_menubutton
end type
end forward
...
global se_cst_menubutton se_cst_menubutton
...
on se_cst_menubutton.create
call super::create
end on

on se_cst_menubutton.destroy
call super::destroy
end on
