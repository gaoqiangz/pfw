$PBExportHeader$se_cst_splitbutton.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_splitbutton from s_cst_splitbutton
end type
end forward
...
global se_cst_splitbutton se_cst_splitbutton
...
on se_cst_splitbutton.create
call super::create
end on

on se_cst_splitbutton.destroy
call super::destroy
end on
