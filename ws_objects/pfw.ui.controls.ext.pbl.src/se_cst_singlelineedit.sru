$PBExportHeader$se_cst_singlelineedit.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_singlelineedit from s_cst_singlelineedit
end type
end forward
...
global se_cst_singlelineedit se_cst_singlelineedit
...
on se_cst_singlelineedit.create
call super::create
end on

on se_cst_singlelineedit.destroy
call super::destroy
end on
