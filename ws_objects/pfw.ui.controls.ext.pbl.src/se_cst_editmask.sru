$PBExportHeader$se_cst_editmask.sru
$PBExportComments$PowerFramework~r~n(c)飞沃共享(深圳)科技有限公司
forward
global type se_cst_editmask from s_cst_editmask
end type
end forward
...
global se_cst_editmask se_cst_editmask
...
on se_cst_editmask.create
call super::create
end on

on se_cst_editmask.destroy
call super::destroy
end on
