...
if _thread.of_GetCount() = 0 then
	...
	//设置事务连接参数
	string sDBParm
	sDBParm = "Provider='MSOLEDBSQL',ProviderString='App=JMP 2021.1113B;WSID=*DEV1510200029#GAOQIANGZ-PC$0E7611AF25B7498BB92DC591DD63EA44;Database=EntTest',TimeOut=30,DataSource='47.115.48.218\JQZ,58960',RecheckRows=1,CommitOnDisconnect='No',DelimitIdentifier=1,DisableBind=1,NCharBind=1,DateFormat='\''yyyy-mm-dd\''',DateTimeFormat='\''yyyy-mm-dd hh:mm:ss.fff\''',TimeFormat='\''hh:mm:ss.fff\'''"
	sqlQuery.of_SetTransData("OLE DB", "47.115.48.218\JQZ,58960", "EntTest", "sa", "aihqwerYJ]=7,)X~~/Wb8%4kz!", sDBParm)
	//设置SQL语句或DataObject
	sqlQuery.of_SetDataObject("dw_setchanges")
